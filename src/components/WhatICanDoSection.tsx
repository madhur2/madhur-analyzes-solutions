        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="p-8 bg-card rounded-lg shadow-card hover:shadow-hover transition-all duration-300 text-center group"
              >
                <div className="p-3 bg-primary/10 rounded-lg mb-6 inline-block group-hover:bg-primary group-hover:text-white transition-colors">
